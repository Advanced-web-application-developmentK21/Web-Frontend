...
const NewTask: React.FC<NewTaskProps> = ({ onAddTask }) => {
  ...
  return (
    <div className="max-w-sm h-auto p-4 bg-white border rounded-md shadow-md">
      <div className="flex justify-center mb-3 border-b-2 border-b-gray-100 ">
        <svg
          width="30"
          height="30"
          viewBox="0 0 64 64"
        ...
        <h2 className="flex rounded-md text-black justify-center text-lg font-semibold  mb-2">
          Create New Task
        </h2>
      </div>
      <div className="form-control mb-2 ">
        ...
        <input
          ...
          className="input size-10 w-full input-bordered border-2 rounded-md border-slate-200 p-3"
        />
      </div>
      <div className="form-control mb-2 ">
        <label className="label ">
        ...
        <input
          ...
          onChange={handleChange}
          className=" input w-full size-10 input-bordered border-2 rounded-md border-slate-200 p-3"
        />
      </div>
      ...
      <div className="pt-3 form-control mb-2">
        <label className="label">
        ...
        <select
          ...
          onChange={handleChange}
          className="select select-bordered w-auto ml-5 cursor-pointer"
        >
